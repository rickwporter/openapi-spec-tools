  ...
  schemas:
    ...
    Card:
      ...
      properties:
        ...
        desc:
          type: string
          example: "\U0001F44BHey there,\n\nTrello's Platform team uses this board
            to keep developers up-to-date."
        descData:
          type: object
          properties:
            emoji:
        ...
        name:
          type: string
          example: "\U0001F44B What? Why? How?"
        pos:
          type: number
          format: float
          example: 65535
          ...
          items:
            ...
            properties:
              ...
              dateLastActive:
                ...
                format: date
                description: The date of the most recent activity on any of the boards
                  in the workspace. If the workspace has no boards, or the boards
                  have no activity, this value will be null.
        claimableCount:
          type: number
          example: 2
    CustomEmoji:
    ...
    Label:
      ...
      properties:
        ...
        color:
          type: string
          "$ref": "#/components/schemas/Color"
          description: The color of the label. Null means no color and the label will
            not be shown on the front of Cards.
    ListFields:
      type: string
      enum:
      - id
    ...
    Member:
      ...
      properties:
        ...
        bio:
          type: string
          example: "\U0001F44B I'm a developer advocate at Trello!"
        bioData:
          type: object
          properties:
            emoji:
        ...
        nonPublicAvailable:
          type: boolean
          example: false
          description: Whether the response contains non-public profile data for the
            member
        products:
          type: array
          items:
...
paths:
  "/actions/{id}":
    ...
    put:
      ...
      description: Update a specific Action. Only comment actions can be updated.
        Used to edit the content of a comment.
    ...
    get:
      ...
      - name: member
        ...
        description: Whether to load the member as a nested resource. See [Members
          Nested Resource](/cloud/trello/guides/rest-api/nested-resources/#members-nested-resource)
        required: false
        schema:
          type: boolean
          default: true
    ...
    get:
      ...
      - name: urls
        ...
        description: A list of API routes. Maximum of 10 routes allowed. The routes
          should begin with a forward slash and should not include the API version
          number - e.g. "urls=/members/trello,/cards/[cardId]"
        required: true
        schema:
          type: string
      deprecated: false
  ...
  "/boards/{id}/memberships":
    get:
      ...
      - name: orgMemberType
        in: query
        description: Shows the type of member to the org the user is. For instance,
          an org admin will have a `orgMemberType` of `admin`.
        required: false
        schema:
          type: boolean
          default: false
  ...
  "/boards/{id}":
    ...
    get:
      ...
      - name: cards
        in: query
        description: This is a nested resource. Read more about cards as nested resources
      ...
      - name: card_pluginData
        in: query
        description: Use with the `cards` param to include card pluginData with the
          response
        required: false
        schema:
          type: boolean
      ...
      - name: fields
        ...
        description: 'The fields of the board to be included in the response. Valid
          values: all or a comma-separated list of: closed, dateLastActivity, dateLastView,
          desc, descData, idMemberCreator, idOrganization, invitations, invited, labelNames,
      ...
      - name: labels
        in: query
        description: This is a nested resource. Read more about labels as nested resources
          [here](/cloud/trello/guides/rest-api/nested-resources/).
        required: false
        schema:
          type: string
      - name: lists
        in: query
        description: This is a nested resource. Read more about lists as nested resources
          [here](/cloud/trello/guides/rest-api/nested-resources/).
        required: false
        schema:
          type: string
      ...
      - name: organization_pluginData
        in: query
        description: Use with the `organization` param to include organization pluginData
          with the response
        required: false
        schema:
          type: boolean
      ...
      - name: tags
        in: query
        description: Also known as collections, tags, refer to the collection(s) that
          a Board belongs to.
        required: false
        schema:
          type: boolean
    ...
    put:
      ...
      - name: prefs/hideVotes
        in: query
        description: Determines whether the Voting Power-Up should hide who voted
          on cards or not.
        required: false
        schema:
          type: boolean
      ...
      - name: prefs/background
        in: query
        description: 'The id of a custom background or one of: blue, orange, green,
  ...
  "/boards/{id}/{field}":
    get:
      ...
      - name: field
        in: path
        description: 'The field you''d like to receive. Valid values: closed, dateLastActivity,
          dateLastView, desc, descData, idMemberCreator, idOrganization, invitations,
          invited, labelNames, memberships, name, pinned, powerUps, prefs, shortLink,
  ...
  "/boards/{boardId}/actions":
    get:
      ...
      description: Get all of the actions of a Board. See [Nested Resources](/cloud/trello/guides/rest-api/nested-resources/)
      ...
      - name: member_fields
        in: query
        description: The fields of the [member](/cloud/trello/guides/rest-api/object-definitions/#member-object)
          to return.
        required: false
        schema:
          type: string
      ...
      - name: before
        in: query
        description: A date string in the form of YYYY-MM-DDThh:mm:ssZ or a mongo
          object ID. Only objects created before this date will be returned.
        required: false
        schema:
          type: string
      - name: since
        in: query
        description: A date string in the form of YYYY-MM-DDThh:mm:ssZ or a mongo
          object ID. Only objects created since this date will be returned.
        required: false
        schema:
          type: string
      deprecated: false
  ...
  "/boards/{id}/cards":
    get:
      ...
      description: Get all of the open Cards on a Board. See [Nested Resources](/cloud/trello/guides/rest-api/nested-resources/)
        for more information.
  ...
  "/boards/{id}/cards/{filter}":
    get:
      ...
      - name: filter
        in: path
        description: 'One of: `all`, `closed`, `complete`, `incomplete`, `none`, `open`,
          `visible`'
        required: true
        schema:
          type: string
  ...
  "/boards/{id}/labels":
    ...
    post:
      ...
      - name: color
        in: query
        description: Sets the color of the new label. Valid values are a label color
          or `null`.
        required: true
        schema:
          type: string
  ...
  "/boards/{id}/lists":
    ...
    post:
      ...
      - name: pos
        in: query
        description: 'Determines the position of the list. Valid values: `top`, `bottom`,
  ...
  "/boards/{id}/members":
    ...
    put:
      ...
      - name: type
        in: query
        description: 'Valid values: admin, normal, observer. Determines what type
          ...
          application/json:
            schema:
              ...
              properties:
                fullName:
                  type: string
                  description: The full name of the user to as a member of the board.
                    Must have a length of at least 1 and cannot begin nor end with
                    a space.
      deprecated: false
      responses:
        '200':
  ...
  "/boards/":
    post:
      ...
      - name: defaultLists
        in: query
        description: Determines whether to add the default set of lists to a board
          (To Do, Doing, Done). It is ignored if `idBoardSource` is provided.
        required: false
        schema:
          type: boolean
          default: true
      ...
      - name: prefs_invitations
        in: query
        description: 'Determines what types of members can invite users to join. One
          of: `admins`, `members`.'
        required: false
        schema:
          type: string
      ...
      - name: prefs_cardAging
        in: query
        description: 'Determines the type of card aging that should take place on
          the board if card aging is enabled. One of: `pirate`, `regular`.'
        required: false
        schema:
          type: string
          default: regular
  ...
  "/cards":
    post:
      ...
      - name: pos
        in: query
        description: The position of the new card. `top`, `bottom`, or a positive
          float
        required: false
        schema:
          oneOf:
      ...
      - name: urlSource
        in: query
        description: A URL starting with `http://` or `https://`. The URL will be
          attached to the card upon creation.
        required: false
        schema:
          type: string
          format: url
      ...
      - name: keepFromSource
        in: query
        description: 'If using `idCardSource` you can specify which properties to
          copy over. `all` or comma-separated list of: `attachments,checklists,customFields,comments,due,start,labels,members,start,stickers`'
        required: false
        style: form
        explode: false
        schema:
  ...
  "/cards/{id}":
    ...
    get:
      ...
      - name: fields
        ...
        description: "`all` or a comma-separated list of [fields](/cloud/trello/guides/rest-api/object-definitions/).
          **Defaults**: `badges, checkItemStates, closed, dateLastActivity, desc,
          descData, due, start, idBoard, idChecklists, idLabels, idList, idMembers,
          idShort, idAttachmentCover, manualCoverAttachment, labels, name, pos, shortUrl,
          url`"
        required: false
        schema:
          type: string
      ...
      - name: membersVoted
        in: query
        description: Whether to return member objects for members who voted on the
          card
        required: false
        schema:
          type: boolean
      ...
      - name: board_fields
        ...
        description: "`all` or a comma-separated list of board [fields](/cloud/trello/guides/rest-api/object-definitions/#board-object).
          **Defaults**: `name, desc, descData, closed, idOrganization, pinned, url,
          prefs`"
        required: false
        schema:
          type: string
    ...
    put:
      ...
      - name: idAttachmentCover
        in: query
        description: The ID of the image attachment the card should use as its cover,
          or null for none
        required: false
        schema:
          "$ref": "#/components/schemas/TrelloID"
      ...
      - name: pos
        in: query
        description: The position of the card in its list. `top`, `bottom`, or a positive
          float
        required: false
        schema:
          oneOf:
      ...
      - name: cover
        ...
        description: "Updates the card's cover\n | Option | Values | About |\n |--------|--------|-------|\n
          | color | `pink`, `yellow`, `lime`, `blue`, `black`, `orange`, `red`, `purple`,
          `sky`, `green` | Makes the cover a solid color . |\n | brightness | `dark`,
          `light` | Determines whether the text on the cover should be dark or light.\n
          | url | An unsplash URL: https://images.unsplash.com | Used if making an
          image the cover. Only Unsplash URLs work.\n | idAttachment | ID of an attachment
          on the card | Used if setting an attached image as the cover. |\n | size
          | `normal`, `full` | Determines whether to show the card name on the cover,
          or below it. |\n \n `brightness` can be sent alongside any of the other
          parameters, but all of the other parameters are mutually exclusive; you
          can not have the cover be a `color` and an `idAttachment` at the same time.
          \n \n On the brightness options, setting it to light will make the text
          on the card cover dark:\n ![](/cloud/trello/images/rest/cards/cover-brightness-dark.png)\n
          \n And vice versa, setting it to dark will make the text on the card cover
        ...
        schema:
          ...
          properties:
            value:
              type: object
              description: "An object containing information regarding the card's
                cover \n `brightness` can be sent alongside any of the other parameters,
                but all of the other parameters are mutually exclusive; you can not
                have the cover be a color and an `idAttachment` at the same time."
              properties:
                color:
                  type: string
                  enum:
                  ...
                  - sky
                  - green
                  description: 'One of: `pink, yellow, lime, blue, black, orange,
                    red, purple, sky, green`'
                  example: pink
                brightness:
                  type: string
                  enum:
                  - dark
                  - light
                  description: Determines whether the text on the cover should be
                    dark or light. Setting it to `light` will make the text on the
                    card cover dark. And vice versa, setting it to dark will make
                    the text on the card cover light
                url:
                  type: string
                  format: url
                  description: Used if making an image the cover. Only Unsplash URLs
  ...
  "/cards/{id}/actions":
    get:
      ...
      description: List the Actions on a Card. See [Nested Resources](/cloud/trello/guides/rest-api/nested-resources/)
        for more information.
      ...
      - name: page
        in: query
        description: The page of results for actions. Each page of results has 50
          actions.
        required: false
        schema:
          type: number
  ...
  "/cards/{id}/attachments":
    ...
    post:
      ...
      description: Create an Attachment to a Card. See https://glitch.com/~trello-attachments-api
        for code examples. You may need to remix the project in order to view it.
      ...
      - name: setCover
        ...
        schema:
          type: boolean
          default: false
        description: Determines whether to use the new attachment as a cover for the
          Card.
      deprecated: false
      responses:
        '200':
  ...
  "/cards/{id}/checklists":
    ...
    post:
      ...
      - name: pos
        in: query
        description: 'The position of the checklist on the card. One of: `top`, `bottom`,
          or a positive number.'
        required: false
        schema:
          type: string
  ...
  "/cards/{idCard}/customField/{idCustomField}/item":
    put:
      ...
      description: Setting, updating, and removing the value for a Custom Field on
        a card. For more details on updating custom fields check out the [Getting
        Started With Custom Fields](/cloud/trello/guides/rest-api/getting-started-with-custom-fields/)
      operationId: put-cards-idcard-customfield-idcustomfield-item
      parameters:
      - name: idCard
        in: path
        description: ID of the card that the Custom Field value should be set/updated
          for
        required: true
        schema:
          "$ref": "#/components/schemas/TrelloID"
            ...
            schema:
              ...
              - type: object
                properties:
                  value:
                    type: object
                    description: An object containing the key and value to set for
                      the card's Custom Field value. The key used to set the value
                      should match the type of Custom Field defined.
                    properties:
                      text:
                        type: string
                      checked:
  ...
  "/cards/{idCard}/customFields":
    put:
      ...
      description: Setting, updating, and removing the values for multiple Custom
        ...
        [Getting Started With Custom Fields](/cloud/trello/guides/rest-api/getting-started-with-custom-fields/)
          ...
          application/json:
            schema:
              ...
              properties:
                customFieldItems:
                  type: array
                  description: An array of objects containing the custom field ID,
                    key and value, and ID of list type option.
                  items:
                    type: object
                    properties:
                      idCustomField:
                      ...
                      value:
                        type: object
                        description: An object containing the key and value to set
                          for the card's Custom Field value. The key used to set the
                          value should match the type of Custom Field defined. This
                          is optional if Custom Field is list type.
                        properties:
                          text:
                            type: string
                          checked:
                      ...
                      idValue:
                        pattern: "^[0-9a-fA-F]{32}$"
                        example: 5abbe4b7ddc1b351ef961414
                        description: The ID of the option for the list type Custom
                          Field. This is optional if Custom Field is not list type.
      deprecated: false
      responses:
        '200':
          description: Success
  ...
  "/checklists":
    post:
      ...
      - name: name
        in: query
        description: The name of the checklist. Should be a string of length 1 to
          16384.
        required: false
        schema:
          type: string
  ...
  "/checklists/{id}":
    ...
    get:
      ...
      - name: cards
        in: query
        description: 'Valid values: `all`, `closed`, `none`, `open`, `visible`. Cards
          is a nested resource. The additional query params available are documented
          at [Cards Nested Resource](/cloud/trello/guides/rest-api/nested-resources/#cards-nested-resource).'
        required: false
        schema:
          type: string
          default: none
      ...
      - name: checkItem_fields
        ...
        description: 'The fields on the checkItem to return if checkItems are being
          returned. `all` or a comma-separated list of: `name`, `nameData`, `pos`,
    ...
    put:
      ...
      - name: name
        in: query
        description: Name of the new checklist being created. Should be length of
          1 to 16384.
        required: false
        schema:
          type: string
  ...
  "/checklists/{id}/{field}":
    ...
    put:
      ...
      - name: value
        in: query
        description: The value to change the checklist name to. Should be a string
  ...
  "/checklists/{id}/checkItems":
    ...
    post:
      ...
      - name: name
        in: query
        description: The name of the new check item on the checklist. Should be a
          ...
          application/json:
            schema:
              ...
              properties:
                idModel:
                  "$ref": "#/components/schemas/TrelloID"
                  description: The ID of the model for which the Custom Field is being
                    defined. This should always be the ID of a board.
                modelType:
                  enum:
                  - board
                  type: string
                  description: The type of model that the Custom Field is being defined
                    on. This should always be `board`.
                name:
                  type: string
                ...
                display_cardFront:
                  type: boolean
                  description: Whether this Custom Field should be shown on the front
                    of Cards
                  default: true
      deprecated: false
      responses:
          ...
          application/json:
            schema:
              ...
              properties:
                ...
                display/cardFront:
                  type: boolean
                  description: Whether to display this custom field on the front of
                    cards
      deprecated: false
      responses:
        '200':
  ...
  "/customFields/{id}/options/{idCustomFieldOption}":
    ...
    get:
      ...
      description: Retrieve a specific, existing Option on a given dropdown-type Custom
        Field
  ...
  "/emoji":
    get:
      ...
      - name: locale
        in: query
        description: The locale to return emoji descriptions and names in. Defaults
          to the logged in member's locale.
        required: false
        schema:
          type: string
      - name: spritesheets
    ...
    get:
      ...
      - name: fields
        ...
        description: 'Comma-separated list of: `id`, `name`, `displayName`, `prefs`,
          `ssoActivationFailed`, `idAdmins`, `idMembers` (Note that the members array
          returned will be paginated if `members` is ''normal'' or ''admins''. Pagination
          can be controlled with member_startIndex, etc, but the API response will
          not contain the total available result count or pagination status data.
          Read the SCIM documentation [here]() for more information on filtering),
          `idOrganizations`, `products`, `userTypes`, `idMembers`, `idOrganizations`'
        required: false
        schema:
          type: string
          default: all
      ...
      - name: member_filter
        ...
        description: Pass a [SCIM-style query](/cloud/trello/scim/) to filter members.
          This takes precedence over the all/normal/admins value of members. If any
          of the member_* args are set, the member array will be paginated.
        required: false
        schema:
          type: string
          default: none
      - name: member_sort
        ...
        description: This parameter expects a [SCIM-style](/cloud/trello/scim/) sorting
          value prefixed by a `-` to sort descending. If no `-` is prefixed, it will
          be sorted ascending. Note that the members array returned will be paginated
      ...
      - name: member_sortBy
        ...
        description: 'Deprecated: Please use member_sort. This parameter expects a
          [SCIM-style sorting value](/cloud/trello/scim/). Note that the members array
          returned will be paginated if `members` is `normal` or `admins`. Pagination
          can be controlled with `member_startIndex`, etc, and the API response''s
          header will contain the total count and pagination state.'
        required: false
        schema:
          type: string
          default: none
      - name: member_sortOrder
        in: query
        description: 'Deprecated: Please use member_sort. One of: `ascending`, `descending`,
          `asc`, `desc`'
        required: false
        schema:
          type: string
  ...
  "/enterprises/{id}/auditlog":
    get:
      ...
      description: "Returns an array of Actions related to the Enterprise object.
        Used for populating data sent to Google Sheets from an Enterprise's audit
        log page: https://trello.com/e/{enterprise_name}/admin/auditlog. An Enterprise
        admin token is required for this route. \n\n NOTE: For enterprises that have
        opted in to user management via AdminHub, the auditlog will will contain actions
  ...
  "/enterprises/{id}/signupUrl":
    get:
      ...
      - name: tosAccepted
        in: query
        description: Designates whether the user has seen/consented to the Trello
          ToS prior to being redirected to the enterprise signup page/their IdP.
        required: false
        schema:
          type: boolean
          default: false
  ...
  "/enterprises/{id}/members/query":
    get:
      ...
      description: Get an enterprise's users. You can choose to retrieve licensed
        members, board guests, etc. The response is paginated and will return 100
        users at a time.
      ...
      - name: licensed
        in: query
        description: When true, returns members who possess a license for the corresponding
          Trello Enterprise; when false, returns members who do not. If unspecified,
          both licensed and unlicensed members will be returned.
        required: false
        schema:
          type: boolean
          default: false
      - name: deactivated
        ...
        description: When true, returns members who have been deactivated for the
          corresponding Trello Enterprise; when false, returns members who have not.
          If unspecified, both active and deactivated members will be returned.
        required: false
        schema:
          type: boolean
          default: false
      - name: collaborator
        in: query
        description: When true, returns members who are guests on one or more boards
          in the corresponding Trello Enterprise (but do not possess a license); when
          false, returns members who are not. If unspecified, both guests and non-guests
          will be returned.
        required: false
        schema:
          type: boolean
      ...
      - name: managed
        ...
        description: When true, returns members who are managed by the corresponding
          Trello Enterprise; when false, returns members who are not. If unspecified,
          both managed and unmanaged members will be returned.
        required: false
        schema:
          type: boolean
          default: none
      - name: admin
        in: query
        description: When true, returns members who are administrators of the corresponding
          Trello Enterprise; when false, returns members who are not. If unspecified,
          both admin and non-admin members will be returned.
        required: false
        schema:
          type: boolean
          default: false
      ...
      - name: search
        in: query
        description: Returns members with email address or full name that start with
          the search value.
        required: false
        schema:
          type: string
      ...
      - name: cursor
        in: query
        description: Cursor to return next set of results, use cursor returned in
          the response to query the next batch.
        required: false
        schema:
          type: string
          default: none
  ...
  "/enterprises/{id}/members":
    get:
      ...
      - name: filter
        ...
        description: Pass a [SCIM-style query](/cloud/trello/scim/) to filter members.
          This takes precedence over the all/normal/admins value of members. If any
          of the below member_* args are set, the member array will be paginated.
        required: false
        schema:
          type: string
          nullable: true
      ...
      - name: sortBy
        in: query
        description: 'Deprecated: Please use `sort` instead. This parameter expects
          a [SCIM-style](/cloud/trello/scim/) sorting value. Note that the members
          array returned will be paginated if `members` is ''normal'' or ''admins''.
          Pagination can be controlled with member_startIndex, etc, but the API response
          will not contain the total available result count or pagination status data.'
        required: false
        schema:
          type: string
      - name: sortOrder
      ...
      - name: organization_fields
        in: query
        description: Any valid value that the [nested organization field resource](/cloud/trello/guides/rest-api/nested-resources/)
          accepts.
        required: false
        schema:
          type: string
      ...
      - name: board_fields
        in: query
        description: Any valid value that the [nested board resource](/cloud/trello/guides/rest-api/nested-resources/)
          accepts.
        required: false
        schema:
          type: string
  ...
  "/enterprises/{id}/transferrable/bulk/{idOrganizations}":
    get:
      ...
      description: Get a list of organizations that can be transferred to an enterprise
        when given a bulk list of organizations.
  ...
  "/enterprises/${id}/enterpriseJoinRequest/bulk":
    put:
      tags: []
      summary: Decline enterpriseJoinRequests from one organization or a bulk list
        of organizations.
  ...
  "/enterprises/{id}/claimableOrganizations":
    get:
      ...
      description: Get the Workspaces that are claimable by the enterprise by ID.
        Can optionally query for workspaces based on activeness/ inactiveness.
      ...
      - name: activeSince
        in: query
        description: Date in YYYY-MM-DD format indicating the date to search up to
          for activeness of workspace
        required: false
        schema:
          type: string
      - name: inactiveSince
  ...
  "/enterprises/{id}/members/{idMember}/licensed":
    put:
      ...
      description: "This endpoint is used to update whether the provided Member should
        use one of the Enterprise's available licenses or not. Revoking a license
        will deactivate a Member of an Enterprise. \n\n NOTE: Revoking of licenses
        is not possible for enterprises that have opted in to user management via
        AdminHub."
  ...
  "/enterprises/{id}/members/{idMember}/deactivated":
    put:
      ...
      - name: organization_fields
        in: query
        description: Any valid value that the [nested organization resource](/cloud/trello/guides/rest-api/nested-resources/)
          accepts.
        required: false
        explode: false
        style: form
  ...
  "/labels/{id}":
    ...
    put:
      ...
      - name: color
        in: query
        description: 'The new color for the label. See: [fields](/cloud/trello/guides/rest-api/object-definitions/)
          for color options'
        required: false
        schema:
          "$ref": "#/components/schemas/Color"
  ...
  "/lists":
    post:
      ...
      - name: pos
        in: query
        description: Position of the list. `top`, `bottom`, or a positive floating
          point number
        required: false
        schema:
          oneOf:
  ...
  "/members/{id}":
    get:
      ...
      - name: cards
        in: query
        description: See the [Cards Nested Resource](/cloud/trello/guides/rest-api/nested-resources/#cards-nested-resource)
  ...
  "/members/{id}/boardStars":
    ...
    post:
      ...
      - name: pos
        in: query
        description: The position of the newly starred board. `top`, `bottom`, or
          a positive float.
        required: true
        schema:
          "$ref": "#/components/schemas/posStringOrNumber"
  ...
  "/members/{id}/savedSearches":
    ...
    post:
      ...
      - name: pos
        in: query
        description: The position of the saved search. `top`, `bottom`, or a positive
          float.
        required: true
        schema:
          "$ref": "#/components/schemas/posStringOrNumber"
  ...
  "/members/{id}/savedSearches/{idSearch}":
    ...
    put:
      ...
      - name: pos
        in: query
        description: New position for saves search. `top`, `bottom`, or a positive
          float.
        required: false
        schema:
          type: string
  ...
  "/notifications/all/read":
    post:
      ...
      - name: read
        in: query
        description: Boolean to specify whether to mark as read or unread (defaults
          to `true`, marking as read)
        required: false
        schema:
          type: boolean
          default: true
      - name: ids
        ...
        description: A comma-seperated list of IDs. Allows specifying an array of
          notification IDs to change the read state for. This will become useful as
          we add grouping of notifications to the UI, with a single button to mark
          all notifications in the group as read/unread.
        schema:
          type: array
          items:
            "$ref": "#/components/schemas/TrelloID"
    ...
    post:
      ...
      - name: name
        ...
        description: A string with a length of at least 3. Only lowercase letters,
          underscores, and numbers are allowed. If the name contains invalid characters,
          they will be removed. If the name conflicts with an existing name, a new
  ...
  "/organizations/{id}":
    ...
    put:
      ...
      - name: displayName
        in: query
        description: A new displayName for the organization. Must be at least 1 character
  ...
  "/organizations/{id}/prefs/orgInviteRestrict":
    delete:
      ...
      description: Remove the email domain restriction on who can be invited to the
        Workspace
  ...
  "/organizations/{id}/newBillableGuests/{idBoard}":
    get:
      ...
      description: Used to check whether the given board has new billable guests on
        it.
  ...
  "/plugins/{idPlugin}/listings/{idListing}":
    put:
      ...
      - name: idListing
        in: path
        description: The ID of the existing listing for the Power-Up that is being
          updated.
        required: true
        schema:
          "$ref": "#/components/schemas/TrelloID"
  ...
  "/search":
    get:
      ...
      - name: modelTypes
        in: query
        description: 'What type or types of Trello objects you want to search. all
          or a comma-separated list of: `actions`, `boards`, `cards`, `members`, `organizations`'
        required: false
        schema:
          type: string
          default: all
      ...
      - name: organization_fields
        in: query
        description: all or a comma-separated list of billableMemberCount, desc, descData,
          displayName, idBoards, invitations, invited, logoHash, memberships, name,
          powerUps, prefs, premiumFeatures, products, url, website
        required: false
        schema:
          type: string
          default: name,displayName
      ...
      - name: partial
        ...
        description: By default, Trello searches for each word in your query against
          exactly matching words within Member content. Specifying partial to be true
          ...
          Report", by default you would need to search for "Development". If you have
  ...
  "/tokens/{token}/webhooks":
    ...
    post:
      ...
      - name: description
        in: query
        description: A description to be displayed when retrieving information about
          the webhook.
        required: false
        schema:
          type: string
  ...
  "/webhooks/{id}":
    ...
    get:
      ...
      description: Get a webhook by ID. You must use the token query parameter and
        pass in the token the webhook was created under, or else you will encounter
        a 'webhook does not belong to token' error.
