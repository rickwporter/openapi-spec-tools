...
def test_op_body_formation_none():
        ...
        pytest.param(
            "ObservationStationCollectionGeoJson",
            {
                'features.id': {
                    ...
                    'type': 'string',
                    'x-field': 'id',
                    'x-forced-single': True,
                    'x-parents': ['features'],
                    'x-reference': 'GeoJsonFeature',
                },
                'features.properties.@id': {
                    ...
                    'x-field': '@id',
                    'x-forced-single': True,
                    'x-parents': ['features', 'properties'],
                    'x-reference': 'ObservationStation',
                },
                ...
                'features.properties.fireWeatherZone': {
                    'description': 'A link to the NWS fire weather forecast zone containing this station.',
                    'format': 'uri',
                    'required': False,
                    'type': 'string',
                    'x-field': 'fireWeatherZone',
                    'x-forced-single': True,
                    'x-parents': ['features', 'properties'],
                    'x-reference': 'ObservationStation',
                },
                'features.properties.forecast': {
                ...
                'features.properties.stationIdentifier': {
                    'required': False,
                    'type': 'string',
                    'x-field': 'stationIdentifier',
                    'x-forced-single': True,
                    'x-parents': ['features', 'properties'],
                    'x-reference': 'ObservationStation',
                },
                'features.properties.timeZone': {
