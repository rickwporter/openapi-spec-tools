...
app = typer.Typer(no_args_is_help=True, help="Manage files styles")
...
def show_commands(
    ...
    _t.tree(path.as_posix(), "files_styles", display, depth, search)
    return


@app.command("show", short_help="Get file styles")
def get_file_styles(
