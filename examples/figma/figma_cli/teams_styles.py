...
app = typer.Typer(no_args_is_help=True, help="Manage teams styles")
...
def show_commands(
    ...
    _t.tree(path.as_posix(), "teams_styles", display, depth, search)
    return


@app.command("list", short_help="Get team styles")
def get_team_styles(
