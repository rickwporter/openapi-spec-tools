...
app = typer.Typer(no_args_is_help=True, help="Manage projects files")
...
def show_commands(
    ...
    _t.tree(path.as_posix(), "projects_files", display, depth, search)
    return


@app.command("show", short_help="Get files in a project")
