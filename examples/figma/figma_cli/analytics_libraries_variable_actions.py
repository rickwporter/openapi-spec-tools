...
app = typer.Typer(no_args_is_help=True, help="Manage analytics libraries variable actions")
...
def show_commands(
    ...
    _t.tree(path.as_posix(), "analytics_libraries_variable_actions", display, depth, search)
    return
...
@app.command("show", short_help="Get library analytics variable action data.")
