...
app = typer.Typer(no_args_is_help=True, help="Manage components")
...
def show_commands(
    ...
    _t.tree(path.as_posix(), "components", display, depth, search)
    return


@app.command("show", short_help="Get component")
def get_component(
