...
app = typer.Typer(no_args_is_help=True, help="Manage teams components")
...
def show_commands(
    ...
    _t.tree(path.as_posix(), "teams_components", display, depth, search)
    return


@app.command("list", short_help="Get team components")
