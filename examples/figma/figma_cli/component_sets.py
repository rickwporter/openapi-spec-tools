...
app = typer.Typer(no_args_is_help=True, help="Manage component-sets")
...
def show_commands(
    ...
    _t.tree(path.as_posix(), "component_sets", display, depth, search)
    return


@app.command("show", short_help="Get component set")
