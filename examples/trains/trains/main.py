...
def get_trips(
    ...
    bicycles: Annotated[Optional[bool], typer.Option(help="Only return trips where bicycles are known to be allowed")] = False,
    dogs: Annotated[Optional[bool], typer.Option(help="Only return trips where dogs are known to be allowed")] = False,
    _api_host: _a.ApiHostOption = "https://try.microcks.io/rest/Train+Travel+API/1.0.0",
    _api_key: _a.ApiKeyOption = None,
    _api_timeout: _a.ApiTimeoutOption = 5,
    _log_level: _a.LogLevelOption = _a.LogLevel.WARN,
